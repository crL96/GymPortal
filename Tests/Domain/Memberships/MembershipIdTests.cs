...
public class MembershipIdTests
{

    [Fact]
    public void Create_Should_Return_Valid_MembershipId()
    {
        // Act
    ...
    {
        // Act
        var id1 = MembershipId.Create();
        var id2 = MembershipId.Create();
    ...
    public void Recreate_Should_Return_Id_When_Guid_Is_Valid()
    {
        ...
        // Act
        var id = MembershipId.Recreate(guid);
